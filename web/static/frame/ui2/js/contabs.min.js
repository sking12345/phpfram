...
$(function() {
    ...
    function s() {
        ...
        if (parentId == "") {
            ...
            if (b) {
                ...
                $(".J_mainContent").append(n);
                //生成选项卡
                var p = '<a href="javascript:;" class="active J_menuTab" data-id="' + url + '" data-index="999" data-reload="' + reload + '">' + title + ' <i class="fa fa-times-circle"></i></a>';
                $(".J_menuTab").removeClass("active");
                $(".J_menuTabs .page-tabs-content").append(p);
            } else {
            ...
            $(".nav-left li[data-index='" + parentId + "']").click();
    ...
    $("body").on("click", ".list-group-item ", s);
    $("body").on("click", ".gritter-item-wrapper", s);
