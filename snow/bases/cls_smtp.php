...
// $smtpusermail = "smtptester2@sina.cn"; //SMTP服务器的用户邮箱

// $smtpemailto = "1281099078@qq.com"; //发送给谁

// $smtpuser = "smtptester2"; //SMTP服务器的用户帐号(或填写new2008oh@126.com，这项有些邮箱需要完整的)

// $smtppass = "test123456"; //SMTP服务器的用户密码

// $mailtitle = "king"; //邮件主题

// $mailcontent = "<h1> tset</h1>"; //邮件内容

// $mailtype = "HTML"; //邮件格式（HTML/TXT）,TXT为文本邮件
// //************************ 配置信息 ****************************

// $smtp = new cls_smtp($smtpserver, $smtpserverport, true, $smtpuser, $smtppass); //这里面的一个true是表示使用身份验证,否则不使用身份验证.
