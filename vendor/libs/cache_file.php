...
use vendor\libs\cache_interface;
...
class cache_file implements cache_interface {
	...
	public function __construct() {
		...
		// $this->_config = config::$instance->cache->file->get();
		$this->file = ROOT_PATH . "/vendor/data/cache/public1.ch";
		if (file_exists(ROOT_PATH . "/vendor/data/cache") == false) {
			mkdir(ROOT_PATH . "/vendor/data/cache");
		}
	}
	public function select_db($db = "") {
		if (!empty($db)) {
			// $this->file = $this->_config["path"] . "/{$db}.ch";
			$this->file = ROOT_PATH . "/vendor/data/cache/{$db}.ch";
		}
		if (file_exists(ROOT_PATH . "/vendor/data/cache") == false) {
			mkdir(ROOT_PATH . "/vendor/data/cache");
		}
