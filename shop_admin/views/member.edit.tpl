...
<div class="content">
    ...
    <form class="form-horizontal Validform" method="POST" ajax=true>
      <script type="text/html" id="edit_info">
        <?=snow\tpl::from_token()?>
            ...
            <div class="box-body">
                    ...
                    <label class="col-sm-2 control-label">性别:</label>
                       <div class="col-sm-4 radio">
                            ...
                            <label class="col-sm-3">
                              ...
                              {{else}}
                               <input type="radio" name="sex"  value="{{i}}">{{item}}
                              {{/if}}
                            </label>
                            {{/each}}
              ...
              <div class="form-group">
                    ...
                    <label class="col-sm-2 control-label">联系电话:</label>
                       <div class="col-sm-4 radio">
                        <input type="text" value="{{infos.phone}}" class="form-control" name="phone">
                      </div>
                  </div>
            </div>
             <div class="form-group">
