...
<body>
    <div class="content">
      <ul class="breadcrumb" style="margin-bottom:5px;background:#FFF;padding-left:0px">
        ...
        <li class="active"><i class="fa fa-fw fa-search"></i>会员等级</li>
        <div class="pull-right">
        <a href="?ctl=<?=snow\req::item('ctl')?>&act=add" class="btn btn-xs  btn-info "><i class="fa fa-plus-circle"></i>添加等级</a>
        </div>
      </ul>
        <div class="box">
                ...
                <table class="table table-bordered table-hover dataTable text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{item.intergral_lower}}</td>
                            <td>{{item.intergral_top}}</td>
                            <td>
                                <a class="btn  btn-info  btn-xs" href="?ctl=<?=snow\req::item('ctl')?>&act=infos&id={{item.id}}">
                                <i class="fa fa-fw fa-search"></i>查看
                            </a> 
                            <a class="btn btn-primary  btn-xs" href="?ctl=<?=snow\req::item('ctl')?>&act=edit&id={{item.id}}">
                                <i class="fa fa-fw fa-edit"></i>编辑
                            </a>
                             <a  class="btn btn-danger btn-xs" href="?ctl=<?=snow\req::item('ctl')?>&act=del&id={{item.id}}">
