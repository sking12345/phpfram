...
<div class="content">
    <ul class="breadcrumb" style="margin-bottom:5px;background:#FFF;padding-left:0px">
        ...
        <li><a href="?ctl=<?=snow\req::item('ctl')?>&act=infos&id=<?=snow\req::item('id')?>">
          <i class="fa fa-fw fa-search"></i>查看等级</a>
        </li>
        <li class="active"><i class="fa fa-fw fa-search"></i>编辑等级</li>
    </ul>
        ...
        <div class="box content" style="min-height:100px">
            <div class="box-body">
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-4">
                         <input type="text" value="{{infos.name}}" class="form-control" errormsg="请输入6个字内的名称" nullmsg="请输入名称" datatype="*" maxlength="20" name="name" placeholder="名称">
                    </div>
                    <label class="col-sm-2 control-label">折扣率:</label>
                       <div class="col-sm-4 radio">
                      <input type="number" value="{{infos.discount_rate}}" class="form-control" value="80" datatype="n" max="100" min="0" name="discount_rate" placeholder="名称">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-4">
                         <input type="number" value="{{infos.intergral_lower}}" class="form-control" datatype="n" name="intergral_lower" placeholder="积分下限">
                    </div>
                    <label class="col-sm-2 control-label">积分上限:</label>
                       <div class="col-sm-4 radio">
                     <input type="number" value="{{infos.intergral_top}}" class="form-control" datatype="n" name="intergral_top" placeholder="积分下限">
                    </div>
                </div>
             <div class="form-group">
