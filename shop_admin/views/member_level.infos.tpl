...
<div class="content">
    <ul class="breadcrumb" style="margin-bottom:5px;background:#FFF;padding-left:0px">
        ...
        <li class="active"><i class="fa fa-fw fa-search"></i>查看等级</li>
    </ul>
            ...
            <div class="box-body">
              <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-4">
                       <p class="form-control-static">{{infos.intergral_lower}}</p>
                         
                    </div>
                    <label class="col-sm-2 control-label">积分上限:</label>
                       <div class="col-sm-4 radio">
                         <p class="form-control-static">{{infos.intergral_top}}</p>
