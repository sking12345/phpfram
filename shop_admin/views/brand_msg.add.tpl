            ...
            <div class="box content" style="min-height:100px">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" errormsg="请输入6个字内的品牌名称" nullmsg="请输入品牌名称" datatype="*" maxlength="6" name="name" placeholder="品牌名称">
                        </div>
                        <label class="col-sm-2 control-label">品牌网址:</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="url" placeholder="品牌网址">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">排序:</label>
                        <div class="col-sm-4">
                            <input type="text" datatype="n" value="10" class="form-control" name="sort" placeholder="排序">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                             <img src="" id="show_img" class="hide" height="50"  align="middle">
