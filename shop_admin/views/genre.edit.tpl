...
<div class="content">
    <ul class="breadcrumb" style="margin-bottom:5px;background:#FFF;padding-left:0px">
        ...
        <li class="active"><i class="fa fa-fw fa-search"></i>编辑类型</li>
    </ul>
        ...
        <div class="box content" style="min-height:100px">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                         <input type="text" class="form-control" errormsg="请输入6个字内的类型名称" nullmsg="请输入类型名称" datatype="*" maxlength="6" name="name" value="{{infos.name}}" placeholder="类型名称">
                    </div>
                  <label class="col-sm-2 control-label">状态:</label>
                    <div class="col-sm-4 radio">
                        ...
                        <label class="col-sm-5">
                             {{if infos.enabled==2}}
                            <input type="radio" name="enabled" checked="true"  value="2">关闭
                            {{else}}
