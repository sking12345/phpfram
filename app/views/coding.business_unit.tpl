            ...
            <div class="box-header with-border">
                <form method="GET" action="" class="form-inline">
                    ...
                    <div class="form-group  pull-right">
                        <a href="?ctl=<?=snow\req::get('ctl')?>&act=add_business_unit" class="btn  btn-info"><i class="fa fa-plus-circle"></i>添加事业部</a>
                    </div>
                </form>
            </div>
            <div class="box-body">
                <table class="table table-bordered table-hover dataTable text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                              ...
                              <td>{{item.code}}</td>
                              <td>
                                <a href="?ctl=<?=snow\req::get('ctl')?>&act=edit_business_unit&id={{item.id}}" class="btn btn-primary  btn-sm"><i class="fa fa-fw fa-edit"></i>编辑</a>
