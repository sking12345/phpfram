...
<div class="content">
    <ol class="breadcrumb" style="margin-bottom:5px;background:#FFF;padding-left:0px">
        <li><a href="?ctl=<?=snow\req::get('ctl')?>&act=kind"><i class="fa fa-fw fa-user"></i>种类</a></li>
        <li class="active"><i class="fa fa-plus-circle"></i>添加种类</li>
    </ol>
        ...
        <div class="box content" style="min-height:100px">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" datatype="n" maxlength="1" value="{{code}}" name="code" placeholder="编号">
                    </div>
                </div>
                  </script>
