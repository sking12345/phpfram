...
<div class="form-div">
  <form action="javascript:searchUser()" name="searchForm">
    ...
    &nbsp;<?php echo $this->_var['lang']['label_user_name']; ?> &nbsp;<input type="text" name="keyword" /> <input type="submit" class="button" value="<?php echo $this->_var['lang']['button_search']; ?>">
  </form>
</div>
...
?>
  <tr>
    ...
    <td align="center"><?php if ($this->_var['user']['is_validated']): ?> <img src="images/yes.svg" width="20"> <?php else: ?> <img src="images/no.svg" width="20"> <?php endif; ?></td>
