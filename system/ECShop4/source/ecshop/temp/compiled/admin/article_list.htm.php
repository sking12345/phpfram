...
<div class="form-div">
  <form action="javascript:searchArticle()" name="searchForm" >
    ...
    <button class="btn" type="submit"><?php echo $this->_var['lang']['button_search']; ?></button>
  </form>
</div>
...
?>
  <tr>
    ...
    <img src="images/<?php if ($this->_var['list']['is_open'] == 1): ?>yes<?php else: ?>no<?php endif; ?>.svg" width="20" onclick="listTable.toggle(this, 'toggle_show', <?php echo $this->_var['list']['article_id']; ?>)" /></span><?php else: ?><img src="images/yes.svg" width="20"><?php endif; ?></td>
    <td align="center"><span><?php echo $this->_var['list']['date']; ?></span></td>
    <td align="center" nowrap="true"><span>
      <a href="../article.php?id=<?php echo $this->_var['list']['article_id']; ?>" target="_blank" title="<?php echo $this->_var['lang']['view']; ?>"><?php echo $this->_var['lang']['view']; ?></a>&nbsp;
      <a href="article.php?act=edit&id=<?php echo $this->_var['list']['article_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><?php echo $this->_var['lang']['edit']; ?></a>&nbsp;
     <!-- <?php if ($this->_var['list']['cat_id'] > 0): ?> --><a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['article_id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><?php echo $this->_var['lang']['remove']; ?></a><!-- <?php endif; ?> --></span>
    </td>
   </tr>
   <?php endforeach; else: ?>
