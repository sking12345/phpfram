        ...
        <table width="90%" id="general-table" align="center" class="gk-table">
          ...
          <tr>
            ...
            <td><select name="cat_id" onchange="hideCatDiv()"><option value="0"><?php echo $this->_var['lang']['select_please']; ?></option><?php echo $this->_var['cat_list']; ?></select>
              ...
              <button type="button" class="btn btn-def " onclick="rapidCatAdd()"><?php echo $this->_var['lang']['rapid_add_cat']; ?></button>
              <span id="category_add" style="display:none;">
              <input type="text" class="text" size="10" name="addedCategoryName" />
               <button type="button" class="btn btn-def " onclick="addCategory()" title="<?php echo $this->_var['lang']['button_submit']; ?>"><?php echo $this->_var['lang']['button_submit']; ?></button>
               <button type="button" class="btn btn-def " onclick="return goCatPage()" title="<?php echo $this->_var['lang']['category_manage']; ?>"><?php echo $this->_var['lang']['category_manage']; ?></button>
               <button type="button" class="btn btn-def " onclick="hideCatDiv()" title="<?php echo $this->_var['lang']['hide']; ?>"><<</button>
               </span>
               <?php endif; ?>
...
<!--            <td><input type="text" name="goods_number" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="20" <?php if ($this->_var['code'] != '' || $this->_var['goods']['_attribute'] != ''): ?>readonly="readonly"<?php endif; ?> /><br />-->
        ...
        <table width="90%" id="properties-table" style="display:none" align="center">
          <tr>
              <td class="label"><a href="javascript:showNotice('noticeGoodsType');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.svg" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php echo $this->_var['lang']['lab_goods_type']; ?></td>
              <td>
