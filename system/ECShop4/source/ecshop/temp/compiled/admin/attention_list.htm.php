...
<div class="form-div">
<form action="attention_list.php" method="post" class="form-horizontal">
  <?php echo $this->_var['lang']['batch_note']; ?>
  <input type="hidden" name="act" value="batch_addtolist" />
  <input name="date" type="text" id="date" size="10" value='' readonly="readonly"><button name="selbtn1" type="button" id="selbtn1" onclick="return showCalendar('date', '%Y-%m-%d', false, false, 'selbtn1');" class="cal"><img src="images/cal.png" alt=""></button>
