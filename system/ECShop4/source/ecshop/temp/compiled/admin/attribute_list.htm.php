...
?>
    <tr>
      ...
      <td align="center" nowrap="true" valign="top">
        <a href="?act=edit&amp;attr_id=<?php echo $this->_var['attr']['attr_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><?php echo $this->_var['lang']['edit']; ?></a>
        <a href="javascript:;" onclick="removeRow(<?php echo $this->_var['attr']['attr_id']; ?>)" title="<?php echo $this->_var['lang']['remove']; ?>"><?php echo $this->_var['lang']['remove']; ?></a>
      </td>
    </tr>
    <?php endforeach; else: ?>
