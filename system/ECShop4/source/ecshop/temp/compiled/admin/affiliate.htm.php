...
<form method="post" action="affiliate.php">
            <table width="100%" border="0" cellspacing="0" cellpadding="4">
                ...
                <tr>
                    <td width="20%" align="right" class="label"><a href="javascript:showNotice('notice1');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.svg" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>" /></a><?php echo $this->_var['lang']['expire']; ?> </td>
                ...
                <tr>
                    <td align="right" class="label"><a href="javascript:showNotice('notice2');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.svg" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>" /></a><?php echo $this->_var['lang']['level_point_all']; ?> </td>
                ...
                <tr>
                    <td align="right" class="label"><a href="javascript:showNotice('notice3');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.svg" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>" /></a><?php echo $this->_var['lang']['level_money_all']; ?> </td>
                ...
                <tr>
                    <td align="right" class="label"><a href="javascript:showNotice('notice4');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.svg" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>" /></a><?php echo $this->_var['lang']['level_register_all']; ?></td>
                ...
                <tr>
                    <td align="right" class="label"><a href="javascript:showNotice('notice5');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.svg" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>" /></a><?php echo $this->_var['lang']['level_register_up']; ?></td>
...
?>
<?php if ($this->_foreach['nav']['iteration'] <= 3): ?>
<tr align="center">
	...
	<td ><a href="javascript:confirm_redirect(lang_removeconfirm, 'affiliate.php?act=del&id=<?php echo $this->_foreach['nav']['iteration']; ?>')"><img src="images/no.svg" width="20"></a></td>
</tr>
<?php endif; ?>
...
onload = function()
{
  ...
  if (document.getElementById("listDiv").childNodes[0].rows.length<4)
  {
