...
?>
  <tr>
    ...
    <td align="center"><img src="images/<?php if ($this->_var['rank']['special_rank']): ?>yes<?php else: ?>no<?php endif; ?>.svg" width="20" onclick="listTable.toggle(this, 'toggle_special', <?php echo $this->_var['rank']['rank_id']; ?>)" /></td>
    <td align="center"><img src="images/<?php if ($this->_var['rank']['show_price']): ?>yes<?php else: ?>no<?php endif; ?>.svg" width="20" onclick="listTable.toggle(this, 'toggle_showprice', <?php echo $this->_var['rank']['rank_id']; ?>)" /></td>
    <td align="center">
    <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['rank']['rank_id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.svg" border="0" height="16" width="16"></a></td>
  </tr>
