...
?>
  <tr>
    ...
    <td align="right"><span>
      ...
      <a href="ads.php?act=add_js&type=<?php echo $this->_var['list']['media_type']; ?>&id=<?php echo $this->_var['list']['ad_id']; ?>" title="<?php echo $this->_var['lang']['add_js_code']; ?>"><?php echo $this->_var['lang']['add_js_code']; ?></a>
      <?php endif; ?>
