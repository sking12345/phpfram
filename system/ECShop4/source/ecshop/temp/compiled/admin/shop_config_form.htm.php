      <tr>
        <td class="label" valign="top">
          ...
          <a href="javascript:showNotice('notice<?php echo $this->_var['var']['code']; ?>');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.svg" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>" /></a>
          <?php endif; ?>
...
?>
          ...
          <?php if (( $this->_var['var']['code'] == "shop_logo" || $this->_var['var']['code'] == "no_picture" || $this->_var['var']['code'] == "watermark" || $this->_var['var']['code'] == "shop_slagon" || $this->_var['var']['code'] == "wap_logo" ) && $this->_var['var']['value']): ?>
            <a href="?act=del&code=<?php echo $this->_var['var']['code']; ?>"><img src="images/no.svg" width="16"></a> <img src="images/yes.svg" width="16" onmouseover="showImg('<?php echo $this->_var['var']['code']; ?>_layer', 'show')" onmouseout="showImg('<?php echo $this->_var['var']['code']; ?>_layer', 'hide')">
            <div id="<?php echo $this->_var['var']['code']; ?>_layer" style="position:absolute; width:100px; height:100px; z-index:1; visibility:hidden" border="1">
              <img src="<?php echo $this->_var['var']['value']; ?>">
            </div>
          <?php else: ?>
