...
?>
    <tr>
      ...
      <td align="center"><img src="images/<?php if ($this->_var['brand']['is_show']): ?>yes<?php else: ?>no<?php endif; ?>.svg" width="20" onclick="listTable.toggle(this, 'toggle_show', <?php echo $this->_var['brand']['brand_id']; ?>)" /></td>
      <td align="center">
