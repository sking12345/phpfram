...
(function(d, f, b) {
    ...
    var a = function(l, n, k) {
        ...
        l.each(function() {
            ...
            o.delegate("input[type=\"checkbox\"][datatype],input[type=\"radio\"][datatype]", "blur", function() {
                var q = arguments[1];
                a.util.check.call(this, o, q);
            });
            o.delegate("[datatype]", "input", function() {
                if ($(this).attr('regType') != undefined) {
                    return;
                }
                var q = arguments[1];
                a.util.check.call(this, o, q);
            ...
            o.delegate("[datatype]", "change", function() {
                var q = arguments[1];
                a.util.check.call(this, o, q);
            });
    ...
    a.util = {
        dataType: {
            ...
            url: /^(\w+:\/\/)?\w+(\.\w+)+.*$/,
            "*09az": /^[0-9a-z]+$/,
            "*09az6-18": /^[0-9a-z]{6,18}$/,
            "*09azAZ": /^[0-9A-Za-z]+$/,
            "*09azAZ6-18": /^[0-9A-Za-z]{6,18}$/,
        },
            ...
            if (v) {
                ...
                if (u.attr("recheck")) {
                    ...
                    if (n != p.val()) {
                        v = false;
                        l = 3;
                        y = u.attr("errmsg") || a.util.getErrormsg.call(u, A, t, "recheck")
                    }
                }
            } else {
                y = y || u.attr("errmsg") || a.util.getErrormsg.call(u, A, t);
