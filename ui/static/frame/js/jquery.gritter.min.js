...
(function($) {
    ...
    $.fn.messageFn = function(opt) {
        ...
        function init() {
            ...
            $("#gritter-item-" + mi).attr("data-index", opt.index);
            $("#gritter-item-" + mi).attr("href", opt.url);
            $("#gritter-item-" + mi).attr("data-item", "other");
            $("#gritter-item-" + mi).attr("data-message", opt.tabTitle);
        }
    }
}(jQuery));
//自定义消息
(function($) {
    ...
    $.fn.notifyFn = function(opt) {
        ...
        function init() {
            ...
            if (opt.url == "") {
                opt.url = "javascript:;";
                str = '<a class="list-group-item" href="' + opt.url + '" data-index="' + opt.index + '" data-Item="other" data-reload="' + opt.reload + '" data-message="' + opt.tabTitle + '">' +
                    '<div class="media"><div class="media-left" ><i class="fa fa-indent" ></i></div><div class="media-body">' +
                    ' <h4 >' + opt.title + '</h4>' +
                    ' <span class="media-meta" >' + opt.time + '</span>'
            } else {
                str = '<a class="list-group-item J_menuItem" href="' + opt.url + '" data-index="' + opt.index + '" data-Item="other" data-reload="' + opt.reload + '" data-message="' + opt.tabTitle + '">' +
                    '<div class="media"><div class="media-left" ><i class="fa fa-indent" ></i></div><div class="media-body">' +
                    ' <h4 >' + opt.title + '</h4>' +
                    ' <span class="media-meta" >' + opt.time + '</span>'
            }
...
$(function() {
    $("body").on("click", ".notify-wrap", function(e) {
    ...
    $(document).on("click", function(e) {
        if ($(e.target).parents(".notify-wrap").length == 0) {
            $(".notify-wrap").removeClass("open");
            $("#notifyWrap .list-group-item").addClass("invalid-item");
            $(".msg-num").html("0").hide();
        } else {
            console.log(1)
